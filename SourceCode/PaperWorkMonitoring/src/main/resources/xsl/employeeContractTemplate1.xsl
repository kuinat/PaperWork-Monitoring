        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="simpleA4" >   >
                ...
                <fo:flow flow-name="xsl-region-body" >
                    ...
                    <fo:block span="all" font-size="16pt" font-weight="bold" space-before="20mm" space-after="5mm"  color="blue" text-align="center" > EMPLOYMENT CONTRACT
                    </fo:block>
                    ...
                    <fo:block span="all" font-size="12pt" > National identity Card:
                        ...
                        <fo:block span="all" font-size="14pt" space-after="5mm" color="blue">
                            WORK DETAILS
                        </fo:block>
